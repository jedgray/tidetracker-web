...
export default function SignInPage() {
  ...
  const [err,      setErr]      = useState<string | null>(
    error === 'CredentialsSignin' ? 'Incorrect email or password.' : null,
  )
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Puget Sound dive planning</p>
        </div>

        <div className="card p-6 space-y-4">
          <h2 className="text-base font-semibold text-gray-800">Sign in</h2>
          ...
          <p className="text-center text-sm text-gray-500">
            No account?{' '}
            <Link href="/auth/signup" className="text-tide-blue font-medium hover:underline">
              Create one
            </Link>
          </p>
        </div>
