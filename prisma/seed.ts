...
const SITES = [
  ...
  { id: 'keystone',  name: 'Keystone Jetty',          region: 'North Sound',   lat: 48.1578, lon: -122.6828, type: 'Jetty / current drift',         depthFt: 60,  skill: 'advanced',    currentWarn: true,  currStationId: 'PCT1516', tideStationId: '9447110' },
  ...
  { id: 'saltcreek', name: 'Salt Creek',              region: 'Strait',        lat: 48.1603, lon: -123.6972, type: 'Reef / wall',                   depthFt: 80,  skill: 'intermediate',currentWarn: true,  currStationId: 'PCT1516', tideStationId: '9443090' },
  { id: 'sekiu',     name: 'Sekiu',                   region: 'Strait',        lat: 48.2695, lon: -124.2961, type: 'Shore / reef',                  depthFt: 70,  skill: 'intermediate',currentWarn: true,  currStationId: 'PCT1516', tideStationId: '9443090' },
]
